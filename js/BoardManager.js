...
BoardManager.prototype.turnCounter = function(){
	this._turn++;
};

BoardManager.prototype.getWhosTurn = function(){
	return (this._turn % 2) == 1 ? Chess.FLAG_O : Chess.FLAG_X;
};

BoardManager.prototype.getPreviousTurn = function(){
	return (this.getWhosTurn() == Chess.FLAG_O) ? Chess.FLAG_X : Chess.FLAG_O;
};

BoardManager.prototype.resetCounter = function(){
	this._turn = 0;
};

BoardManager.prototype.isGameOver = function(){
	return this._isGameover;
};

BoardManager.prototype.allowFlagPlacement = function(){
	this._isGameover = false;
};

BoardManager.prototype.forbitFlagPlacement = function(){
...
BoardManager.prototype.printBoard = function(){
