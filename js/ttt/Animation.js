define(["./TicTacToe"], function(TicTacToe){
	TicTacToe.Animation = (function(){
		...
		Animation.prototype.setX = function(x) { this._x = x || 0; };
		Animation.prototype.getX = function() { return this._x; };
		Animation.prototype.setY = function(y) { this._y = y || 0; };
		Animation.prototype.getY = function() { return this._y; };
		...
		Animation.prototype.getCurrentFrame = function(){ return this._array[this._currIndex].img; };
		Animation.prototype.setLoop = function(loop){ this._loop = loop; };
		Animation.prototype.isLoop = function(){ return this._loop; };
